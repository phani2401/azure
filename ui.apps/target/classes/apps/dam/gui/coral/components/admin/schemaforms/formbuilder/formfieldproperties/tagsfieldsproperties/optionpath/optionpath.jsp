...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("class", "field-tags-optionpath-descriptor");
    values.put("fieldLabel",   i18n.get("Tags Location"));
    values.put("emptyText",    i18n.get("enter path to tags..."));
    values.put("value",        cfg.get("optionPath", "/etc/tags"));
    values.put("name",         "./items/" + resource.getName() + "/optionPath");
