...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("text",      i18n.get("Disable edit"));
    values.put("value",     cfg.get("disabled", false));
    values.put("checked",   cfg.get("disabled", false));
    values.put("name",      "./items/" + resource.getName() + "/disabled");
