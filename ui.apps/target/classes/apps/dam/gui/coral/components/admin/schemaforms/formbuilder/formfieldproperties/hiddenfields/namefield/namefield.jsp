...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("class", "field-hidden-name-descriptor");
    values.put("fieldLabel",   i18n.get("Name"));
    values.put("emptyText",    i18n.get("name..."));
    values.put("value",        cfg.get("name", ""));
