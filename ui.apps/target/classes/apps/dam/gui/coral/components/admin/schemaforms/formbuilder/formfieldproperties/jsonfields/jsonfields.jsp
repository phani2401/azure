...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("class", "json-path-descriptor");
    values.put("fieldLabel",   i18n.get("JSON Path"));
    values.put("emptyText",    cfg.get("emptyText", i18n.get("JSON Path")));
    values.put("value",        i18n.getVar(fieldProperties.get("jsonPath", String.class)));
    values.put("name",         "./items/" + resource.getName() + "/jsonPath");
