...
<div class="formbuilder-content-form">
    <sling:include resource="<%= resource %>" resourceType="granite/ui/components/foundation/form/formbuilder/sectionfield" />
</div>
<div class="formbuilder-content-properties">
    ...
    <input type="hidden" name="./items/<%= key %>/sling:resourceType" value="dam/gui/components/admin/schemaforms/formbuilder/sectionfield">
    ...
    <%
        ...
        String[] settingsList = {"labelfields", "titlefields", "metadatamappertextfield", "disableineditmodefields", };
