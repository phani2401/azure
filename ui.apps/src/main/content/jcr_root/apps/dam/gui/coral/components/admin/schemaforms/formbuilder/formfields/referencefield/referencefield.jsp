...
<label class="fieldtype">
    <i class="coral-Icon coral-Icon--sizeXS coral-Icon--link"></i><%=i18n.get("Asset Referenced By") %>
</label>
...
<div class="formbuilder-content-properties">
    ...
    <input type="hidden" name="./items/<%= key %>/sling:resourceType" value="dam/gui/components/admin/references">
    <input type="hidden" name="./items/<%= key %>/granite:data/metaType" value="reference">
