...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("class", "field-text-descriptor");
    values.put("fieldLabel",   i18n.get("Field Text"));
    values.put("emptyText",    i18n.get("field text"));
    values.put("value",        cfg.get("text", ""));
    values.put("name",        "./items/" + resource.getName() + "/text");
