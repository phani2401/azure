...
if(formPath == null || formPath.trim().isEmpty() || formPathRes == null){
    return;
}
Conf conf = formPathRes.adaptTo(Conf.class);
String formPathOOTB = conf.getItem(DamConfigurationConstants.ADMIN_UI_OOTB_CONF_RELPATH).get(DamConfigurationConstants.METADATA_SCHEMA_HOME, DamConfigurationConstants.OOTB_METADATA_SCHEMA_FORM_HOME);
