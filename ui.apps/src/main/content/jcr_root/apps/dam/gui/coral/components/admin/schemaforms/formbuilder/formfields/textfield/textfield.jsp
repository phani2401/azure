...
<div class="formbuilder-content-form">
    <label class="fieldtype"><i class="coral-Icon coral-Icon--sizeXS coral-Icon--text"></i><%= i18n.get("Text Field") %></label>
...
<div class="formbuilder-content-properties">
    ...
    <input type="hidden" name="./items/<%= key %>/sling:resourceType" value="granite/ui/components/coral/foundation/form/textfield">
    <input type="hidden" name="./items/<%= key %>/granite:data/metaType" value="text">
