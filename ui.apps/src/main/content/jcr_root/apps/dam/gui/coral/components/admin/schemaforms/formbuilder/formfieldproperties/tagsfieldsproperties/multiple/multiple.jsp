...
%><%@ page session="false" contentType="text/html" pageEncoding="utf-8"
    ...
    values.put("class",     "checkbox-label tags-multiple");
    values.put("text",      i18n.get("Multiple"));
...
<input type="hidden" name="./items/<%= resource.getName() %>/multiple@Delete" value="true">
<input type="hidden" name="./items/<%= resource.getName() %>/multiple@TypeHint" value="Boolean">